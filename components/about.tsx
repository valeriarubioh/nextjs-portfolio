...
export default function About() {
  const { ref, inView } = useInView({ threshold: 0.75 }); //Comes from de pckg intersection observer. It will return an array with the ref to the DOM element you want to monitor, and inView the status.
